...
def one_by_one(data):
    ...
    data["outbounds"] = [item for item in data["outbounds"] if not ("transport" in item and 'path' in item["transport"] and item["transport"]['path'][0]=='%' and len(item["transport"]['path'])<5)]
